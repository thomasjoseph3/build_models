within ThermofluidStream_v2.Undirected.FlowControl;
model SpecificValveType "Specific technical valve types"

  extends ThermofluidStream_v2.Undirected.FlowControl.Internal.PartialValve;

  import FlowCoeffType = ThermofluidStream_v2.FlowControl.Internal.Types.FlowCoefficientTypes;

  replaceable record ZetaValueRecord =
    ThermofluidStream_v2.FlowControl.Internal.Curves.SlideValveZetaCurve
    constrainedby ThermofluidStream_v2.FlowControl.Internal.Curves.PartialCharacteristicZetaCurves "Select valve type"
