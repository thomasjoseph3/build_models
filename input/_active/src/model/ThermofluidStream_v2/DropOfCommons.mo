...
model DropOfCommons "Model for global parameters"
  ...
  parameter Boolean displayInstanceNames = false "= true, if ThermofluidStream_v2 instance names are displayed" annotation(Dialog(group="Layout"),Evaluate=true, HideResult=true, choices(checkBox=true));
