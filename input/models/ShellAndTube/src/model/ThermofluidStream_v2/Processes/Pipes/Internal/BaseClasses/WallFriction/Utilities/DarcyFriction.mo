within ThermofluidStream_v2.Processes.Pipes.Internal.BaseClasses.WallFriction.Utilities;
...
protected
  ...
  algorithm
    // Interpolation
    (y,dy_dx) := ThermofluidStream_v2.Processes.Pipes.Internal.Utilities.cubicHermite_withDerivative(
        x,
        x1,
        x2,
        y1,
