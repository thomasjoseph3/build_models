within ThermofluidStream_v2.FlowControl;
model Switch
  ...
  ThermofluidStream_v2.Interfaces.Outlet outletA(redeclare package Medium=Medium)
    annotation (Placement(transformation(extent={{-20,-20},{20,20}}, origin={100,0})));
  ThermofluidStream_v2.Interfaces.Outlet outletB(redeclare package Medium=Medium)
  ...
  ThermofluidStream_v2.FlowControl.TanValve tanValve(redeclare package Medium = Medium,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={0,40})));
  ThermofluidStream_v2.FlowControl.TanValve tanValve1(redeclare package Medium = Medium,
    ...
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={40,0})));
  ThermofluidStream_v2.Topology.SplitterT2 splitterT2_1(redeclare package Medium = Medium, L=0)
