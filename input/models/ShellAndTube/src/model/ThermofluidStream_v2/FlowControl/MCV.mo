...
model MCV "Flow rate control valve"
  extends ThermofluidStream_v2.Interfaces.SISOFlow(final clip_p_out=false, final L = 100, final p_min=p_min_par);
  ...
  import Mode = ThermofluidStream_v2.FlowControl.Internal.Types.MassflowControlValveMode;
  ...
  final parameter Boolean displayM = mode == ThermofluidStream_v2.FlowControl.Internal.Types.MassflowControlValveMode.mass_flow
    annotation(Evaluate=true, HideResult=true);
  final parameter Boolean displayV = mode == ThermofluidStream_v2.FlowControl.Internal.Types.MassflowControlValveMode.volume_flow
    annotation(Evaluate=true, HideResult=true);
...
<p><img src=\"modelica://ThermoFluidStream/Resources/Doku/ThermofluidStream_v2.FlowControl.MCV.PNG\"/></p>
</html>"));
end MCV;
