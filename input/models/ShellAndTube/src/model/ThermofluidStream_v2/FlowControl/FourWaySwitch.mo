...
model FourWaySwitch
  ...
  ThermofluidStream_v2.Interfaces.Inlet inletA(redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{-120,40},{-80,80}}), iconTransformation(extent={{-120,40},{-80,80}})));
  ThermofluidStream_v2.Interfaces.Inlet inletB(redeclare package Medium = Medium)
  ...
  Switch switch1(
    ...
    annotation (Placement(transformation(
        ...
        rotation=180,
        origin={60,-60})));
  ThermofluidStream_v2.Topology.JunctionT2 junctionT2_1(redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{-70,-70},{-50,-50}})));
  ThermofluidStream_v2.Topology.JunctionT2 junctionT2_2(redeclare package Medium = Medium)
    annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={60,60})));
