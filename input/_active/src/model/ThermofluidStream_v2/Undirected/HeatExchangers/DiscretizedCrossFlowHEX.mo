within ThermofluidStream_v2.Undirected.HeatExchangers;
model DiscretizedCrossFlowHEX "Discretized heat exchanger for single- or two-phase working fluid without pressure drop"
  ...
  Processes.FlowResistance flowResistanceA[nCells](
    ...
    each l=1,
    redeclare function pLoss = ThermofluidStream_v2.Processes.Internal.FlowResistance.linearQuadraticPressureLoss (each k=50)) annotation (Placement(transformation(extent={{-20,-70},{-40,-50}})));
