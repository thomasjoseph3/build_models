...
package Functions
  ...
  constant ThermofluidStream_v2.Media.myMedia.Interfaces.Choices.ReferenceEnthalpy
    referenceChoice=ThermofluidStream_v2.Media.myMedia.Interfaces.Choices.ReferenceEnthalpy.ZeroAt0K
    "Choice of reference enthalpy";
  constant ThermofluidStream_v2.Media.myMedia.Interfaces.Types.SpecificEnthalpy h_offset=0.0
  ...
  algorithm
    h_der := dT*
      ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.cp_T(data, T);
  ...
  algorithm
    h_der := dT*
      ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.cp_Tlow(data,
      T);
    annotation(Inline=true,smoothOrder=2);
  end h_Tlow_der;
  ...
  function s0_Tlow "Compute specific entropy, low T region"
    ...
    output SI.SpecificEntropy s "Specific entropy at temperature T";
  algorithm
    s := data.R_s*(data.blow[2] - 0.5*data.alow[1]/(T*T) - data.alow[2]/T +
      data.alow[3]*Modelica.Math.log(T) + T*(data.alow[4] + T*(0.5*data.alow[5]
       + T*(1/3*data.alow[6] + 0.25*data.alow[7]*T))));
    annotation (Inline=true, smoothOrder=2);
  end s0_Tlow;
