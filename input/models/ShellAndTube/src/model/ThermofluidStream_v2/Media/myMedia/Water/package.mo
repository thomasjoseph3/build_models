...
import ThermofluidStream_v2.Media.myMedia.Water.ConstantPropertyLiquidWater.simpleWaterConstants;

constant
  ThermofluidStream_v2.Media.myMedia.Interfaces.Types.TwoPhase.FluidConstants[1] waterConstants(
