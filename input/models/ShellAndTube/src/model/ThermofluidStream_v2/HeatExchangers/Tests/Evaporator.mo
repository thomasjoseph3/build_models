...
model Evaporator
  ...
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm(redeclare package
      Medium = MediumAir,
    ...
    pressureUnit="bar") annotation (
      Placement(transformation(
        ...
        rotation=0,
        origin={47,-14})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm1(redeclare package
      Medium = MediumAir,
    digits=3,
