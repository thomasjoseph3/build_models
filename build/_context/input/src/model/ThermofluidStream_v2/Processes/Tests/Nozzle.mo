...
Medium model for the test. Can be anything.
  ...
  ThermofluidStream_v2.Processes.Nozzle nozzle(
  ...
  ThermofluidStream_v2.Processes.Nozzle nozzle1(
    redeclare package Medium = Medium,
    A_in=0.01,
  ...
  inner ThermofluidStream_v2.DropOfCommons dropOfCommons annotation (
