within ThermofluidStream_v2.Examples.Utilities;
...
<p>Model of the medium in the Piston. The medium is typically Two-phase.</p>
  ...
  parameter ThermofluidStream_v2.Utilities.Units.Inertance L = dropOfCommons.L "Inertance at inlet and outlet"
  ...
  SI.Pressure r_left_intern=ThermofluidStream_v2.Undirected.Internal.regStep(
      m_flow_left,
      medium_left.p - Medium.pressure(state_in_left),
      0,
      m_flow_reg);
  SI.Pressure r_right_intern=ThermofluidStream_v2.Undirected.Internal.regStep(
      m_flow_right,
