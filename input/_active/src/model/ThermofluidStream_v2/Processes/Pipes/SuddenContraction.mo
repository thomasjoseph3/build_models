...
model SuddenContraction "Pressure drop due to contraction using Modelica.Fluid.Dissipation.PressureLoss.Orifice"
  ...
  parameter SI.Pressure dp_0 = 0 "Initial value for pressure difference dp"
    annotation(Dialog(tab = "Initialization", group = "dp", enable = (initdp == ThermofluidStream_v2.Utilities.Types.InitializationMethods.state)));
  parameter ThermofluidStream_v2.Utilities.Units.MassFlowAcceleration dp_acceleraton_0 = 0 "Initial value for der(dp)"
    annotation(Dialog(tab = "Initialization", group = "dp", enable = (initdp == ThermofluidStream_v2.Utilities.Types.InitializationMethods.derivative)));
...
<p>
This component models a <strong>sudden pipe contraction</strong>. It computes the pressure loss of the fluid depending on the massflow rate or the massflow rate depending on a given pressure difference, 
...
<p>
The pressure loss is calculated with the <strong>same functions </strong> used in the <a href=\"modelica://ThermofluidStream_v2.Processes.Pipes.SuddenExpansion\">SuddenExpansion</a> model. To obtain an 
...
<p>
The pipe bend component is using the partial model <a href=\"modelica://ThermofluidStream_v2.Processes.Pipes.Interfaces.SISOFlow_nonConstArea\">SISOFlow_nonConstArea</a> implementing the common flow balances.  
...
<img src=\"modelica://ThermofluidStream_v2/Resources/Doku/Fluid_HTWG/HTWG_en_Markenzeichen_klein_pos_1C.png\" alt=\"HTWG Konstanz\" width=\"350\" height=\"100\">
    ...
    graphics={
      ...
      Line(
          ...
          thickness=0.5),
        Polygon(
          points={{-80,40},{-80,-40},{0,-40},{0,-20},{80,-20},{80,20},{0,20},{0,40},{-80,40}},
          lineColor={0,140,72},
          fillColor={170,255,170},
          fillPattern=FillPattern.Solid)}));
end SuddenContraction;
