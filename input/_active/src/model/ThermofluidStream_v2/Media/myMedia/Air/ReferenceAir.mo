...
package ReferenceAir
  ...
  constant
    ThermofluidStream_v2.Media.myMedia.Interfaces.Types.TwoPhase.FluidConstants airConstants(
...
public
  package Air_ph
    ...
    extends ThermofluidStream_v2.Media.myMedia.Air.ReferenceAir.Air_Base(
...
The package Air_ph can be used as any other medium model (see <a href=\"modelica://Modelica.Media.UsersGuide\">User's Guide of Media Library</a> for further information).
  ...
  package Air_pT
    ...
    extends Modelica.Icons.MaterialProperty;
    extends ThermofluidStream_v2.Media.myMedia.Air.ReferenceAir.Air_Base(
      ThermoStates=ThermofluidStream_v2.Media.myMedia.Interfaces.Choices.IndependentVariables.pT,
...
public
  package Air_dT
    ...
    extends Modelica.Icons.MaterialProperty;
    extends ThermofluidStream_v2.Media.myMedia.Air.ReferenceAir.Air_Base(
      ThermoStates=ThermofluidStream_v2.Media.myMedia.Interfaces.Choices.IndependentVariables.dTX,
      final ph_explicit=false,
...
public
  partial package Air_Base
    ...
    extends ThermofluidStream_v2.Media.myMedia.Interfaces.PartialPureSubstance(
      mediumName="Air",
      substanceNames={"air"},
      singleState=false,
    ...
    algorithm
      MM := ThermofluidStream_v2.Media.myMedia.Air.ReferenceAir.airConstants.molarMass;
      annotation (Inline=true);
    end molarMass;
...
<p>Many further properties can be computed. Using the well-known Bridgman's Tables, all first partial derivatives of the standard thermodynamic variables can be computed easily.</p>
  ...
  package Air_Utilities
    ...
    package Basic "Fundamental equation of state"
      ...
      constant ThermofluidStream_v2.Media.myMedia.Common.FundamentalConstants Constants(
        final R_bar=8.31451,
        final R_s=287.117,
  ...
  protected
    package ThermoFluidSpecial
      ...
      algorithm
        d :=
          ThermofluidStream_v2.Media.myMedia.Air.ReferenceAir.Air_Utilities.Inverses.dofpT(
                p=p,
                T=T,
                delp=1e-7);
        f := Air_Utilities.Basic.Helmholtz(d, T);
