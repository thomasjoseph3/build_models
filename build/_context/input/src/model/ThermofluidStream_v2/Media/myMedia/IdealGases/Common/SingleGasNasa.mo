...
partial package SingleGasNasa
  ...
  extends Interfaces.PartialPureSubstance(
     ...
     redeclare final record FluidConstants =
        ThermofluidStream_v2.Media.myMedia.Interfaces.Types.IdealGas.FluidConstants,
  ...
  import ThermofluidStream_v2.Media.myMedia.Interfaces.Choices.ReferenceEnthalpy;
...
"); MM = data.MM;
    R_s = data.R_s;
    h = ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.h_T(
        data,
        T,
        ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.excludeEnthalpyOfFormation,
        ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.referenceChoice,
        ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.h_offset);
    u = h - R_s*T;
  ...
  redeclare function extends specificEnthalpy "Return specific enthalpy"
    extends Modelica.Icons.Function;
  algorithm
    h := ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.h_T(data,
      state.T);
    annotation(Inline=true,smoothOrder=2);
  ...
  redeclare function extends specificInternalEnergy
    ...
    extends Modelica.Icons.Function;
  algorithm
    u := ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.h_T(data,
  ...
  redeclare function extends specificEntropy "Return specific entropy"
    extends Modelica.Icons.Function;
  algorithm
    s := ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.s0_T(data,
  ...
  redeclare function extends specificGibbsEnergy "Return specific Gibbs energy"
    extends Modelica.Icons.Function;
  algorithm
    g := ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.h_T(data,
  ...
  redeclare function extends specificHelmholtzEnergy
    ...
    extends Modelica.Icons.Function;
  algorithm
    f := ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.h_T(data,
  ...
  algorithm
    cp := ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.cp_T(data,
      state.T);
    annotation(Inline=true,smoothOrder=2);
  ...
  algorithm
    cv := ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.cp_T(data,
      state.T) - data.R_s;
    annotation(Inline=true,smoothOrder=2);
  ...
  algorithm
    a := sqrt(max(0, data.R_s*state.T*
      ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.cp_T(data,
  ...
  algorithm
    h_is := ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.h_T(
        data,
        state.T,
        exclEnthForm,
        refChoice,
  ...
  algorithm
    ...
    "Failed to compute dynamicViscosity: For the species \"" + mediumName + "\" no critical data is available.");
    eta :=
      ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.dynamicViscosityLowPressure(
        state.T,
  ...
  algorithm
    ...
    lambda :=
      ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.thermalConductivityEstimate(
...
// the functions below are not strictly necessary, there are just here for compatibility reasons
  ...
  function dynamicViscosityLowPressure
    ...
    input ThermofluidStream_v2.Media.myMedia.Interfaces.Types.DipoleMoment mu
      "Dipole moment of gas molecule";
    input Real k =  0.0 "Special correction for highly polar substances";
    output ThermofluidStream_v2.Media.myMedia.Interfaces.Types.DynamicViscosity eta
...
<p>T. Skoglund, Lund, Sweden, 2004-08-31</p>
  ...
  function thermalConductivityEstimate
    ...
    extends Modelica.Icons.Function;
    input ThermofluidStream_v2.Media.myMedia.Interfaces.Types.SpecificHeatCapacity
      Cp "Constant pressure heat capacity";
    input ThermofluidStream_v2.Media.myMedia.Interfaces.Types.DynamicViscosity eta
      "Dynamic viscosity";
    input Integer method(min=1,max=2)=1
      "1: Eucken Method, 2: Modified Eucken Method";
    input IdealGases.Common.DataRecord data "Ideal gas data";
    output ThermofluidStream_v2.Media.myMedia.Interfaces.Types.ThermalConductivity
