...
Medium package used in the Test.
  ...
  ThermofluidStream_v2.FlowControl.PCV pCV(
  ...
  ThermofluidStream_v2.Boundaries.VolumeFlex
                                      volumeFlex2(
    redeclare package Medium = Medium,
    useInlet=false,
    p_start=200000,
  ...
  ThermofluidStream_v2.FlowControl.PCV pCV1(
    redeclare package Medium = Medium,
    L=10,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    mode=ThermofluidStream_v2.FlowControl.Internal.Types.PressureControlValveMode.outlet,
  ...
  ThermofluidStream_v2.Boundaries.Source source(redeclare package Medium = Medium, p0_par=100000)
  ...
  ThermofluidStream_v2.FlowControl.PCV pCV2(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    m_flow_0=10,
    pressure_set_par(displayUnit="Pa") = 20000) annotation (Placement(transformation(extent={{10,-80},{30,-60}})));
  ThermofluidStream_v2.Boundaries.Source source1(redeclare package Medium = Medium, p0_par=200000)
  ...
  ThermofluidStream_v2.FlowControl.PCV pCV3(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    m_flow_0=10,
    pressureFromInput=true,
    pressure_set_par(displayUnit="Pa")) annotation (Placement(transformation(extent={{-20,10},{0,30}})));
  ThermofluidStream_v2.Boundaries.Source source2(redeclare package Medium = Medium, p0_par=200000)
  ...
  ThermofluidStream_v2.FlowControl.PCV pCV4(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    m_flow_0=10,
    mode=ThermofluidStream_v2.FlowControl.Internal.Types.PressureControlValveMode.outlet,
