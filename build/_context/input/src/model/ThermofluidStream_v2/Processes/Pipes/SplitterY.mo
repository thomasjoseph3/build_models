...
<p>
The Y-Splitter component is extending the partial model <a href=\"modelica://ThermofluidStream_v2.Processes.Pipes.Interfaces.partialSplitterY\">partialSplitterY</a> implementing the common flow balances 
for fluid splitting components. For the pressure loss calculation the functions 
<a href=\"modelica://ThermofluidStream_v2.Processes.Pipes.BaseClasses.PressureLoss.Splitter.dp_SplitterWyeType1_DP\">dp_SplitterWyeType1_DP</a> and 
<a href=\"modelica://ThermofluidStream_v2.Processes.Pipes.BaseClasses.PressureLoss.Splitter.dp_SplitterWyeType2_DP\">dp_SplitterWyeType2_DP</a> are used <strong>depending on the users geometry input</strong>.
...
in the common channel (inlet section). For more information on the pressure loss function <a href=\"modelica://ThermofluidStream_v2.Processes.Pipes.BaseClasses.PressureLoss.Splitter\">click here</a>.
</p>
