...
model EdgedBend "Pressure drop due to edged bend using Modelica.Fluid.Dissipation.PressureLoss.Bend"
  ...
  parameter ThermofluidStream_v2.Utilities.Types.InitializationMethods initdp = ThermofluidStream_v2.Utilities.Types.InitializationMethods.none "Initialization method for pressure difference dp"
...
<p>
The pipe bend component is using the partial model <a href=\"modelica://ThermofluidStream_v2.Processes.Pipes.Interfaces.SISOFlowBend\">SISOFlowBend</a> implementing the common flow balances.  For the 
