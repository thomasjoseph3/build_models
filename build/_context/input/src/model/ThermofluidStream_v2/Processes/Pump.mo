...
model Pump "A simple pump model"
  ...
  replaceable function dp_tau_pump =
    ...
    annotation(choices(
       choice=ThermofluidStream_v2.Processes.Internal.TurboComponent.pleaseSelect_dp_tau "Please select function",
       choice=ThermofluidStream_v2.Processes.Internal.TurboComponent.dp_tau_centrifugal "Centrifugal Pump",
       choice=ThermofluidStream_v2.Processes.Internal.TurboComponent.dp_tau_nominal_flow "Nominal Flow Pump"),
