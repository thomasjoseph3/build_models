within ThermofluidStream_v2.FlowControl.Tests;
model MCV "Test for MCV"
  extends Modelica.Icons.Example;

  replaceable package Medium = ThermofluidStream_v2.Media.myMedia.Air.SimpleAir
    constrainedby ThermofluidStream_v2.Media.myMedia.Interfaces.PartialMedium "Medium package"
...
Medium package used in the Test.
  ...
  inner ThermofluidStream_v2.DropOfCommons dropOfCommons(assertionLevel=AssertionLevel.warning)
  ...
  ThermofluidStream_v2.Boundaries.Sink sink(redeclare package Medium = Medium, p0_par=100000)
    annotation (Placement(transformation(extent={{50,20},{70,40}})));
  ThermofluidStream_v2.FlowControl.MCV mCV(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    mode=ThermofluidStream_v2.FlowControl.Internal.Types.MassflowControlValveMode.mass_flow,
  ...
  ThermofluidStream_v2.FlowControl.MCV mCV1(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    mode=ThermofluidStream_v2.FlowControl.Internal.Types.MassflowControlValveMode.volume_flow,
    massFlow_set_par=0.1,
  ...
  ThermofluidStream_v2.Boundaries.Sink sink2(redeclare package Medium = Medium, p0_par=100000)
    annotation (Placement(transformation(extent={{50,-40},{70,-20}})));
  ThermofluidStream_v2.FlowControl.MCV mCV2(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    mode=ThermofluidStream_v2.FlowControl.Internal.Types.MassflowControlValveMode.volume_flow,
    massFlow_set_par=0.1,
  ...
  ThermofluidStream_v2.Boundaries.Sink sink3(redeclare package Medium = Medium, p0_par=100000)
    annotation (Placement(transformation(extent={{50,-70},{70,-50}})));
  ThermofluidStream_v2.FlowControl.MCV mCV3(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    mode=ThermofluidStream_v2.FlowControl.Internal.Types.MassflowControlValveMode.mass_flow,
    massFlow_set_par=0.1,
  ...
  ThermofluidStream_v2.Boundaries.Source source4(
    redeclare package Medium = Medium,
    pressureFromInput=true,
    T0_par(displayUnit="K") = 300,
    p0_par=200000) annotation (Placement(transformation(extent={{-40,-100},{-20,-80}})));
  ThermofluidStream_v2.Boundaries.Sink sink4(redeclare package Medium = Medium, p0_par=100000)
    annotation (Placement(transformation(extent={{50,-100},{70,-80}})));
  ThermofluidStream_v2.FlowControl.MCV mCV4(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    mode=ThermofluidStream_v2.FlowControl.Internal.Types.MassflowControlValveMode.mass_flow,
    massFlow_set_par=0.1,
  ...
  ThermofluidStream_v2.Boundaries.Source source5(
    redeclare package Medium = Medium,
    pressureFromInput=false,
    T0_par(displayUnit="K") = 300,
    p0_par=200000) annotation (Placement(transformation(extent={{-40,60},{-20,80}})));
  ThermofluidStream_v2.Boundaries.Sink sink5(redeclare package Medium = Medium, p0_par=100000)
    annotation (Placement(transformation(extent={{50,60},{70,80}})));
  ThermofluidStream_v2.FlowControl.MCV mCV5(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    mode=ThermofluidStream_v2.FlowControl.Internal.Types.MassflowControlValveMode.volume_flow,
    setpointFromInput=true,
  ...
  ThermofluidStream_v2.FlowControl.MCV mCV6(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    mode=ThermofluidStream_v2.FlowControl.Internal.Types.MassflowControlValveMode.mass_flow,
    massFlow_set_par=1,
