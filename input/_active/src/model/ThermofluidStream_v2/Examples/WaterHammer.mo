...
model WaterHammer "Pump water by using dynamic pressures"
  ...
  inner ThermofluidStream_v2.DropOfCommons dropOfCommons(assertionLevel = AssertionLevel.warning, displayInstanceNames=false)
  ...
  ThermofluidStream_v2.Boundaries.Sink sink1(
    redeclare package Medium = Medium,
    p0_par=100000)
  ...
  ThermofluidStream_v2.FlowControl.CheckValve checkValve(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state)
  ...
  ThermofluidStream_v2.Utilities.Icons.DLRLogo dLRLogo annotation (Placement(transformation(extent={{82,-98},{118,-62}})));
equation
