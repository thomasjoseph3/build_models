...
model BasicControlValve "Basic valve model with optional flow characteristics for incompressible fluids"
  ...
  import FlowCoeffType = ThermofluidStream_v2.FlowControl.Internal.Types.FlowCoefficientTypesBasic;

  replaceable function valveCharacteristics =
    ThermofluidStream_v2.FlowControl.Internal.ControlValve.linearCharacteristics
    constrainedby ThermofluidStream_v2.FlowControl.Internal.ControlValve.partialValveCharacteristics
