within ThermofluidStream_v2.Undirected.Boundaries;
model PhaseSeparator "Base model for receiver and accumulator models"
  ...
  import Init = ThermofluidStream_v2.Boundaries.Internal.InitializationMethodsPhaseSeperator;
  ...
  parameter Init init_method = ThermofluidStream_v2.Boundaries.Internal.InitializationMethodsPhaseSeperator.l "Initialization Method"
