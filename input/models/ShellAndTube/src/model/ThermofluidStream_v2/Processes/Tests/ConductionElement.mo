within ThermofluidStream_v2.Processes.Tests;
...
meant for liquids with low compressablility.
  ...
  ThermofluidStream_v2.Processes.ConductionElement conductionElement(
    ...
    A=35,
    U=500,
    init=ThermofluidStream_v2.Processes.Internal.InitializationMethodsCondElement.T,
  ...
  ThermofluidStream_v2.Processes.ConductionElement conductionElement1(
    redeclare package Medium = Medium,
    L=0.2,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    V(displayUnit="l") = 0.001,
    ...
    A=35,
    U=500,
    init=ThermofluidStream_v2.Processes.Internal.InitializationMethodsCondElement.h,
    T_0=263.15,
    h_0=7e4) annotation (Placement(transformation(extent={{-10,20},{10,0}})));
  ThermofluidStream_v2.Processes.ConductionElement conductionElement2(
    redeclare package Medium = Medium,
    L=0.2,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    V(displayUnit="l") = 0.001,
    A=35,
    U=500,
    init=ThermofluidStream_v2.Processes.Internal.InitializationMethodsCondElement.inlet,
    T_0=263.15,
  ...
  ThermofluidStream_v2.Processes.ConductionElement conductionElement3(
    redeclare package Medium = Medium,
    L=0.2,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    V(displayUnit="l") = 0.001,
  ...
  ThermofluidStream_v2.Processes.ConductionElement conductionElement4(
    redeclare package Medium = Medium,
    L=0.2,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    V(displayUnit="l") = 0.001,
