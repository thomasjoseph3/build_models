within ThermofluidStream_v2.Undirected.HeatExchangers.Tests;
model TestDiscretizedHEXvsDir

  extends Modelica.Icons.Example;

  replaceable package MediumAir = Media.myMedia.Air.DryAirNasa
    constrainedby ThermofluidStream_v2.Media.myMedia.Interfaces.PartialMedium
  ...
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm4(
    redeclare package Medium = MediumAir,
    temperatureUnit="degC",
    pressureUnit="bar") annotation (
      Placement(transformation(
        ...
        rotation=0,
        origin={31,-72})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm5(
    redeclare package Medium = MediumAir,
    digits=3,
    outputMassFlowRate=true,
  ...
  ThermofluidStream_v2.Boundaries.Sink sinkB(
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={64,2})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm6(
    redeclare package Medium = MediumRefrigerant,
    digits=3,
    temperatureUnit="degC")
  ...
  Modelica.Blocks.Sources.RealExpression refFlow_setPoint1(y=0.2)
    annotation (Placement(transformation(extent={{10,10},{-10,-10}},
        rotation=0,
        origin={26,16})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm7(
    redeclare package Medium = MediumRefrigerant,
    digits=3,
    outputMassFlowRate=true,
    temperatureUnit="degC")
  ...
  ThermofluidStream_v2.HeatExchangers.DiscretizedCounterFlowHEX evaporator(
    redeclare model ConductionElementB =
        ThermofluidStream_v2.HeatExchangers.Internal.ConductionElementHEX_twoPhase,
    redeclare package MediumA = MediumAir,
    redeclare package MediumB = MediumRefrigerant,
    initializeMassFlow=true,
    nCells=10,
    ...
    annotation (Placement(transformation(extent={{10,10},{-10,-10}},
        rotation=180,
        origin={0,-56})));
  ThermofluidStream_v2.Processes.FlowResistance flowResistanceA1(
    redeclare package Medium = MediumAir,
    m_flow_0=1,
    r=0.05,
    l=1,
  ...
  ThermofluidStream_v2.Processes.FlowResistance flowResistanceB1(
    redeclare package Medium = MediumRefrigerant,
    m_flow_0=0.3,
    r=0.05,
    l=1,
  ...
  ThermofluidStream_v2.Sensors.SingleSensorSelect singleSensorSelect1(
    ...
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.h_Jpkg)
    annotation (Placement(transformation(extent={{-20,-34},{-40,-14}})));
  ThermofluidStream_v2.Sensors.TwoPhaseSensorSelect sensorVaporQuality(
    redeclare package Medium = MediumRefrigerant,
  ...
  ThermofluidStream_v2.Sensors.TwoPhaseSensorSelect sensorVaporQuality1(
    redeclare package Medium = MediumRefrigerant,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.x_kgpkg)
    annotation (Placement(transformation(extent={{20,-22},{40,-2}})));
  ThermofluidStream_v2.Boundaries.Source sourceA1(
    redeclare package Medium = MediumAir,
    T0_par=311.15,
    p0_par=100000)
    annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-112,-168})));
  ThermofluidStream_v2.Boundaries.Sink sinkA1(
    redeclare package Medium = MediumAir,
    pressureFromInput=true,
    p0_par=100000) annotation (Placement(transformation(extent={{102,-178},{122,-158}})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm8(
    redeclare package Medium = MediumAir,
    temperatureUnit="degC",
    pressureUnit="bar") annotation (
      Placement(transformation(
        ...
        rotation=0,
        origin={-37,-158})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm9(
    redeclare package Medium = MediumAir,
    digits=3,
    outputMassFlowRate=true,
    temperatureUnit="degC") annotation (Placement(transformation(
        ...
        rotation=180,
        origin={52,-158})));
  ThermofluidStream_v2.Boundaries.Source sourceB1(
    redeclare package Medium = MediumRefrigerant,
    setEnthalpy=true,
    temperatureFromInput=false,
    pressureFromInput=true,
    ...
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},
        rotation=270,
        origin={80,-206})));
  ThermofluidStream_v2.Boundaries.Sink sinkB1(
    redeclare package Medium = MediumRefrigerant,
    pressureFromInput=false,
    ...
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},
        rotation=90,
        origin={-76,-228})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm10(
    redeclare package Medium = MediumRefrigerant,
    digits=3,
    temperatureUnit="degC")
  ...
  Modelica.Blocks.Sources.RealExpression refFlow_setPoint2(y=0.3)
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-28,-244})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm11(
    redeclare package Medium = MediumRefrigerant,
    digits=3,
    outputMassFlowRate=true,
    temperatureUnit="degC")
  ...
  ThermofluidStream_v2.HeatExchangers.DiscretizedCounterFlowHEX condenser(
    redeclare package MediumA = MediumAir,
    redeclare package MediumB = MediumRefrigerant,
    redeclare model ConductionElementB =
        ThermofluidStream_v2.HeatExchangers.Internal.ConductionElementHEX_twoPhase,
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=180,
        origin={-2,-174})));
  ThermofluidStream_v2.Processes.FlowResistance flowResistanceA2(
    redeclare package Medium = MediumAir,
    m_flow_0=0.5,
    r=0.05,
    l=1,
  ...
  ThermofluidStream_v2.Processes.FlowResistance flowResistanceB2(
    redeclare package Medium = MediumRefrigerant,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.none,
    m_flow_0=0.3,
    r=0.05,
    l=1,
    redeclare function pLoss = ThermofluidStream_v2.Processes.Internal.FlowResistance.laminarTurbulentPressureLoss (
  ...
  ThermofluidStream_v2.Sensors.TwoPhaseSensorSelect sensorVaporQuality2(
    redeclare package Medium = MediumRefrigerant,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.x_kgpkg)
    annotation (Placement(transformation(extent={{-24,-230},{-44,-210}})));
  ThermofluidStream_v2.Sensors.TwoPhaseSensorSelect sensorVaporQuality3(
    redeclare package Medium = MediumRefrigerant,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.x_kgpkg)
