within ThermofluidStream_v2.Undirected.FlowControl.Tests;
model BasicControlValve "Test for undirected BasicControlValve"
  extends Modelica.Icons.Example;

  replaceable package Medium =
      ThermofluidStream_v2.Media.myMedia.Water.ConstantPropertyLiquidWater
...
Medium package used in the Test.
  ...
  FlowControl.BasicControlValve valveParabolic(
    ...
    Kvs=5,
    redeclare function valveCharacteristics =
        ThermofluidStream_v2.FlowControl.Internal.ControlValve.parabolicCharacteristics,
    m_flow_ref_set=0.1)
  ...
  FlowControl.BasicControlValve valveEqualPercentage(
    ...
    Kvs=5,
    redeclare function valveCharacteristics =
        ThermofluidStream_v2.FlowControl.Internal.ControlValve.equalPercentageCharacteristics)
