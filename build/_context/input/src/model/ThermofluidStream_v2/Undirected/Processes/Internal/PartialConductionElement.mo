within ThermofluidStream_v2.Undirected.Processes.Internal;
partial model PartialConductionElement "Partial model of quasi-stationary mass and heat transfer"
  ...
  parameter ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement init=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.rear "Initialization method for specific enthalpy"
  ...
  parameter SI.Temperature T_0 = Medium.T_default "Initial Temperature"
    annotation(Dialog(tab="Initialization", group="Specific enthalpy", enable=(init == ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.T)));
  parameter SI.SpecificEnthalpy h_0 = Medium.h_default "Initial specific enthalpy"
    annotation(Dialog(tab="Initialization", group="Specific enthalpy", enable=(init == ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.h)));
...
<div>
<img src=\"modelica://ThermofluidStream_v2/Resources/Doku/ThermofluidStream_v2.Processes.ConductionElement_positive.png\"/>
</div>
<p>
