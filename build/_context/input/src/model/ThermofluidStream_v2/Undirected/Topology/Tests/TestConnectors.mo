...
<p>This is the replaceable package that determines the medium of the Test. </p>
  ...
  ThermofluidStream_v2.Boundaries.Source source1(redeclare package Medium = Medium,
    p0_par=100000,
  ...
  ThermofluidStream_v2.Boundaries.Source source2(redeclare package Medium = Medium,
      p0_par=100000)
  ...
  Processes.FlowResistance flowResistance(
    ...
    redeclare function pLoss =
        .ThermofluidStream_v2.Processes.Internal.FlowResistance.laminarPressureLoss)
  ...
  Boundaries.BoundaryFore boundary_fore4(redeclare package Medium = Medium, pressureFromInput=true)
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=0,
        origin={40,-50})));
  ThermofluidStream_v2.Boundaries.CreateState createState(
    redeclare package Medium = Medium,
    PFromInput=true)
  ...
  Boundaries.BoundaryFore boundary_fore5(redeclare package Medium = Medium, pressureFromInput=true)
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=0,
        origin={64,-90})));
  ThermofluidStream_v2.Boundaries.Source source3(redeclare package Medium = Medium, p0_par=200000)
    annotation (Placement(transformation(extent={{-80,-78},{-60,-58}})));
  ThermofluidStream_v2.Boundaries.Sink sink3(
    redeclare package Medium = Medium,
  ...
  ThermofluidStream_v2.Processes.FlowResistance flowResistance3(
    redeclare package Medium = Medium, initM_flow = ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    l=5,
    redeclare function pLoss =
        ThermofluidStream_v2.Processes.Internal.FlowResistance.laminarTurbulentPressureLoss,
    r(displayUnit="mm") = 0.005)
