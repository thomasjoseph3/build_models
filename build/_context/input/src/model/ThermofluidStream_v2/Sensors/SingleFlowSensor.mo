...
model SingleFlowSensor "Flow rate sensor"
  ...
  final parameter String quantityString=
    ...
    elseif quantity == ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.H_flow_Jps then "H_flow in W"
    elseif quantity == ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.S_flow_JpKs then "S_flow in W/K"
    elseif quantity == ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.Cp_flow_JpKs then "Cp_flow in W/K"
    else "error";
