within ThermofluidStream_v2.Examples;
model HeatPump
  ...
  Processes.Compressor compressor(
    ...
    enableOutput=true,
    outputQuantity=ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.m_flow_kgps,
    initOmega=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    initPhi=true,
  ...
  FlowControl.BasicControlValve controlValve(
    ...
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    invertInput=true,
    flowCoefficient=ThermofluidStream_v2.FlowControl.Internal.Types.FlowCoefficientTypesBasic.Kvs,
  ...
  Utilities.Receiver receiver(
    ...
    p_start=420000,
    init_method=ThermofluidStream_v2.Boundaries.Internal.InitializationMethodsPhaseSeperator.h,
    h_0=220e3)
  ...
  Sensors.SingleFlowSensor singleFlowSensor(
    redeclare package Medium = Medium,
    digits=4,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.m_flow_kgps) annotation (Placement(transformation(extent={{-20,86},{-40,66}})));
  ...
  Sensors.SingleSensorSelect singleSensorSelect2(
    ...
    digits=1,
    outputValue=true,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.T_C) annotation (Placement(transformation(extent={{-10,100},{10,120}})));
  Sensors.SingleSensorSelect singleSensorSelect3(
    redeclare package Medium = Air,
    digits=1,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.T_C) annotation (Placement(transformation(extent={{-120,100},{-100,120}})));
  Sensors.SingleSensorSelect singleSensorSelect4(
    redeclare package Medium = Air,
    digits=1,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.T_C) annotation (Placement(transformation(extent={{-12,-150},{8,-130}})));
  Sensors.SingleSensorSelect singleSensorSelect5(
    redeclare package Medium = Air,
    digits=1,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.T_C) annotation (Placement(transformation(extent={{-124,-128},{-104,-108}})));
  ...
  ThermofluidStream_v2.Utilities.showRealValue showRealValue(
    use_numberPort=false,
    description="COP",
    number=condenser.Q_flow_A/max(0.00001, compressor.W_t)) annotation (Placement(transformation(extent={{80,-94},{154,-56}})));
  ThermofluidStream_v2.Utilities.Icons.DLRLogo dLRLogo annotation (Placement(transformation(extent={{142,-158},{198,-102}})));
equation
