within ThermofluidStream_v2.Topology;
package Internal
...
<p>Medium package used in the Component. Make sure it is the same one as all the components connected to all fluid ports are using. </p>
    ...
    parameter ThermofluidStream_v2.Utilities.Units.Inertance L=dropOfCommons.L "Inertance of each inlet/outlet"
    ...
    ThermofluidStream_v2.Interfaces.Outlet outletA(redeclare package Medium = Medium) annotation (Placement(transformation(
          extent={{-20,-20},{20,20}},
          rotation=90,
          origin={0,100})));
    ThermofluidStream_v2.Interfaces.Outlet outletB(redeclare package Medium = Medium) annotation (Placement(transformation(
          extent={{-20,-20},{20,20}},
          rotation=0,
          origin={100,0})));
  ...
  equation
    ...
    elseif mode == SplitterModes.OneMinusS then
      ...
      p_A = ThermofluidStream_v2.Undirected.Internal.regStep(dp, p_in - dp, p_in, p_reg);
    end if;
    p_B = p_A + dp;
...
<p><img src=\"modelica://ThermofluidStream_v2/Resources/Doku/ThermofluidStream_v2.Topology.Internal.SplitterRatio.PNG\"/><img src=\"modelica://ThermofluidStream_v2/Resources/Doku/ThermofluidStream_v2.Topology.Internal.SplitterRatio2.PNG\"/></p>
</html>"));
  end SplitterRatio;
