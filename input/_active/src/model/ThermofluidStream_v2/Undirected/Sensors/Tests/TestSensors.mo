within ThermofluidStream_v2.Undirected.Sensors.Tests;
...
<p>Replaceable package with the medium model. Due to the vaporQuality sensor it must be a TwoPhaseMedium.</p>
  ...
  ThermofluidStream_v2.Sensors.TwoPhaseSensorSelect sensor_vaporQuality1(
    redeclare package Medium = Medium, quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.x_kgpkg)
    annotation (Placement(transformation(extent={{50,28},{70,8}})));
  SingleFlowSensor singleFlowSensor(redeclare package Medium = Medium, quantity=ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.H_flow_Jps)
  ...
  SingleFlowSensor singleFlowSensor1(
    redeclare package Medium = Medium,
    outputValue=true,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.H_flow_Jps,
  ...
  ThermofluidStream_v2.Sensors.DifferenceTwoPhaseSensorSensorSelect differenceTwoPhaseSensorSensorSelect(
    redeclare package MediumA = Medium,
    redeclare package MediumB = Medium,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.p_sat_Pa,
    outputValue=true,
