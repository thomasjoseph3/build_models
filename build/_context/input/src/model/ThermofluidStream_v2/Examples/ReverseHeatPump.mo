...
model ReverseHeatPump
  ...
  Undirected.HeatExchangers.DiscretizedCounterFlowHEX discretizedHEX(
    ...
    init_B=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.fore,
    nCells=5,
  ...
  Undirected.HeatExchangers.DiscretizedCounterFlowHEX discretizedHEX1(
    ...
    redeclare model ConductionElementB =
        Undirected.HeatExchangers.Internal.ConductionElementHEX_twoPhase,
    init_B=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.rear,
    nCells=5,
    initializeMassFlow=false,
    k_wall=300) annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
  ...
  Undirected.Topology.ConnectInletFore connectInletFore1(
    redeclare package Medium = RefrigerantMedium) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={46,40})));
  ThermofluidStream_v2.Utilities.Icons.DLRLogo dLRLogo annotation (Placement(transformation(extent={{122,-78},{178,-22}})));
...
<p><img src=\"modelica://ThermofluidStream_v2/Resources/Doku/ThermofluidStream_v2.Examples.ReverseHeatPump.png\"/></p>
