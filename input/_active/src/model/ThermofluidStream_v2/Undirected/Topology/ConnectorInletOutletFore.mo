within ThermofluidStream_v2.Undirected.Topology;
...
<p>This is the replaceable package that determines the medium of the Connector. Make sure it fits the medium in all models connected to inlet and port of the Connector.</p>
  ...
  ThermofluidStream_v2.FlowControl.CheckValve checkValve1(
    redeclare package Medium = Medium,
    final L=L,
    final m_flow_ref=m_flow_ref,
    final p_ref=p_ref)
  ...
  ThermofluidStream_v2.Sensors.SensorState sensorState(redeclare package Medium = Medium)
