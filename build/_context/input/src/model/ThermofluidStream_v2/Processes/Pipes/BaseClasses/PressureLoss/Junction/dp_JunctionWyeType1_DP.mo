within ThermofluidStream_v2.Processes.Pipes.BaseClasses.PressureLoss.Junction;
function dp_JunctionWyeType1_DP
  extends Modelica.Icons.Function;

  import SMOOTH = ThermofluidStream_v2.Processes.Pipes.Internal.Utilities.Stepsmoother;
  // Input variables
  ...
  output ThermofluidStream_v2.Processes.Pipes.Internal.Types.PressureLossCoefficient zeta_cb
    "Pressure loss coefficient of branching inlet w.r.t. outlet velocity";
  output ThermofluidStream_v2.Processes.Pipes.Internal.Types.PressureLossCoefficient zeta_cs
