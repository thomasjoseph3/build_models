within ThermofluidStream_v2.Processes.Pipes.Internal.Interfaces;
partial model SISOFlow_nonConstArea "SISOFlow considering dynamic effects due to different inlet/outlet cross sectional areas"
  ...
  import ThermofluidStream_v2.Utilities.Types.InitializationMethods;

  replaceable package Medium = ThermofluidStream_v2.Media.myMedia.Interfaces.PartialMedium "Medium model"
    annotation (
  ...
  parameter ThermofluidStream_v2.Utilities.Units.Inertance L = dropOfCommons.L "Inertance of the flow"
    annotation(Dialog(tab = "Advanced"));
  parameter StateSelect m_flowStateSelect = StateSelect.default "State select for m_flow"
    annotation(Dialog(tab = "Advanced"));
  parameter InitializationMethods initM_flow = ThermofluidStream_v2.Utilities.Types.InitializationMethods.none "Initialization method for m_flow"
  ...
  parameter ThermofluidStream_v2.Utilities.Units.MassFlowAcceleration m_acceleraton_0 = 0 "Initial value for der(m_flow)"
  ...
  ThermofluidStream_v2.Interfaces.Inlet inlet(redeclare package Medium = Medium)
    annotation(Placement(transformation(extent = {{-120, -20}, {-80, 20}}), iconTransformation(extent = {{-120, -20}, {-80, 20}})));
  ThermofluidStream_v2.Interfaces.Outlet outlet(redeclare package Medium = Medium)
...
equation
  ...
  annotation (
    Documentation(info="<html>
<p> 
Extended version of <a href=\"modelica://ThermofluidStream_v2.Interfaces.SISOFlow\">SISOFlow</a> to <strong>restore Bernoulli's principle</strong> (change of static pressure due to change of velocity), 
