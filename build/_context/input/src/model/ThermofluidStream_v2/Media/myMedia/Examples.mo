...
is given to compare the approximation.
  ...
  model MixtureGases "Test gas mixtures"
    ...
    package Medium1 =
        ThermofluidStream_v2.Media.myMedia.IdealGases.MixtureGases.CombustionAir
      "Medium model";
    ...
    package Medium2 =
        ThermofluidStream_v2.Media.myMedia.IdealGases.MixtureGases.SimpleNaturalGas
      "Medium model";
  ...
  model PsychrometricData "Produces plot data for psychrometric charts"
    extends Modelica.Icons.Example;
    package Medium = ThermofluidStream_v2.Media.myMedia.Air.MoistAir
      "Used medium package";
...
<li><strong>y_phi</strong>: constant relative humidity</li>
  ...
  package TwoPhaseWater "Extension of the StandardWater package"
    extends ThermofluidStream_v2.Media.myMedia.Water.StandardWater;
...
points, e.g., when an isentropic reference state is computed.
  ...
  package ReferenceAir
    ...
    model DryAir1 "Example 1 for dry air"
      extends Modelica.Icons.Example;
      extends
        ThermofluidStream_v2.Media.myMedia.Examples.Utilities.PartialTestModel(
          redeclare package Medium =
            ThermofluidStream_v2.Media.myMedia.Air.ReferenceAir.Air_pT);
    ...
    model DryAir2 "Example 2 for dry air"
      extends Modelica.Icons.Example;
      extends
        ThermofluidStream_v2.Media.myMedia.Examples.Utilities.PartialTestModel2(
          redeclare package Medium =
            ThermofluidStream_v2.Media.myMedia.Air.ReferenceAir.Air_pT);
      annotation (__DLR_experiment(StopTime=1.01));
    end DryAir2;
    ...
    model MoistAir "Example for moist air"
      ...
      package Medium = ThermofluidStream_v2.Media.myMedia.Air.ReferenceMoistAir
        "Medium model";
      Medium.BaseProperties medium(
    ...
    model MoistAir1 "Example 1 for moist air"
      ...
      extends
        ThermofluidStream_v2.Media.myMedia.Examples.Utilities.PartialTestModel(
          redeclare package Medium =
            ThermofluidStream_v2.Media.myMedia.Air.ReferenceMoistAir);
      annotation (__DLR_experiment(StopTime=1.01));
    end MoistAir1;
    ...
    model Inverse_sh_T
      ...
      import Medium = ThermofluidStream_v2.Media.myMedia.Air.ReferenceAir.Air_pT
        "Medium model";
    ...
    model Inverse_sh_TX
      ...
      import Medium = ThermofluidStream_v2.Media.myMedia.Air.ReferenceMoistAir
        "Medium model";
      ...
      parameter SI.Temperature T_max=500
        "Vary temperature linearly from T_min (time=0) up to T_max (time=1)";
      parameter SI.Pressure p=1.0e5 "Fixed pressure in model";
      parameter SI.MassFraction[:] X=ThermofluidStream_v2.Media.myMedia.Air.ReferenceMoistAir.reference_X
        "Mass fraction vector";
      final parameter SI.SpecificEnthalpy h_min=
          ThermofluidStream_v2.Media.myMedia.Air.ReferenceMoistAir.specificEnthalpy(
          ThermofluidStream_v2.Media.myMedia.Air.ReferenceMoistAir.setState_pTX(
                p,
                T_min,
      ...
      final parameter SI.SpecificEntropy s_min=
          ThermofluidStream_v2.Media.myMedia.Air.ReferenceMoistAir.specificEntropy(
          ThermofluidStream_v2.Media.myMedia.Air.ReferenceMoistAir.setState_pTX(
                p,
                T_min,
  ...
  package R134a "Examples for R134a"
    ...
    model R134a1 "Example 1 for R134a"
      ...
      extends
        ThermofluidStream_v2.Media.myMedia.Examples.Utilities.PartialTestModel(
        redeclare package Medium =
            ThermofluidStream_v2.Media.myMedia.R134a.R134a_ph,
        h_start=107390,
...
output window.
    ...
    model Inverse_sh_T
      ...
      replaceable package Medium = ThermofluidStream_v2.Media.myMedia.Air.DryAirNasa
        constrainedby ThermofluidStream_v2.Media.myMedia.IdealGases.Common.SingleGasNasa
...
The numerical computation of the inverse function is performed by function <a href=\"modelica://Modelica.Math.Nonlinear.solveOneNonlinearEquation\">Modelica.Math.Nonlinear.solveOneNonlinearEquation</a> in both cases.
    ...
    model InverseIncompressible_sh_T
      ...
      replaceable package Medium = ThermofluidStream_v2.Media.myMedia.Incompressible.Examples.Glycol47
        "Medium model"
...
The numerical computation of the inverse function is performed by function <a href=\"modelica://Modelica.Math.Nonlinear.solveOneNonlinearEquation\">Modelica.Math.Nonlinear.solveOneNonlinearEquation</a> in both cases.
    ...
    model Inverse_sh_TX
      ...
      replaceable package Medium = ThermofluidStream_v2.Media.myMedia.IdealGases.MixtureGases.FlueGasLambdaOnePlus
        constrainedby ThermofluidStream_v2.Media.myMedia.IdealGases.Common.MixtureGasNasa
        "Medium model" annotation (choicesAllMatching=true);
