...
sum(X) = c*(sum(X_a) - sum(X_b)) + (sum(X_a) + sum(X_b))/2
  ...
  function Gibbs2_ph
    ...
    extends Modelica.Icons.Function;
    input ThermofluidStream_v2.Media.myMedia.Common.GibbsDerivs2 g
      "Dimensionless derivatives of Gibbs function";
    output ThermofluidStream_v2.Media.myMedia.Common.NewtonDerivatives_ph nderivs
      "Derivatives for Newton iteration to calculate d and t from p and h";
  ...
  function Gibbs2_dT
    ...
    input ThermofluidStream_v2.Media.myMedia.Common.GibbsDerivs2 g
      "Dimensionless derivatives of Gibbs function";
    output ThermofluidStream_v2.Media.myMedia.Common.NewtonDerivatives_dT nderivs
  ...
  function Gibbs2_ps
    ...
    input ThermofluidStream_v2.Media.myMedia.Common.GibbsDerivs2 g
      "Dimensionless derivatives of Gibbs function";
    output ThermofluidStream_v2.Media.myMedia.Common.NewtonDerivatives_ps nderivs
