within ThermofluidStream_v2.Sensors;
model DifferenceSensorSelect "Sensor for selectable quantatiy difference"

  extends ThermofluidStream_v2.Utilities.DropOfCommonsPlus(displayInstanceName = false);

  import ThermofluidStream_v2.Sensors.Internal.Types.Quantities;
