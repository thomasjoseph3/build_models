...
model Diffuser "Pressure drop of a conical diffusor"
  ...
  parameter SI.Length ks "Pipe roughness"
    annotation(Dialog(group="Roughness",enable=ThermofluidStream_v2.Processes.Internal.Material.other));
  //Advanced
  parameter ThermofluidStream_v2.Utilities.Units.Inertance L_value = dropOfCommons.L "Inertance of pipe" annotation (
...
For more information <a href=\"modelica://ThermofluidStream_v2.Processes.Pipes.BaseClasses.PressureLoss.Diffuser.dp_conicalDiffuserOverall_DP\">click here</a>. The functions assumes pressure loss coefficient 
