...
model Test_Diffusor
  ...
  ThermofluidStream_v2.Boundaries.Sink sink(redeclare package Medium = Medium, p0_par=100000) annotation (Placement(transformation(extent={{20,-10},
            {40,10}})));
  ThermofluidStream_v2.Processes.Pipes.Diffuser diffuser(
