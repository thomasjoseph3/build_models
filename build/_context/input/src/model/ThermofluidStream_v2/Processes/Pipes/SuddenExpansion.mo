...
model SuddenExpansion "Pressure drop due to expansion using Modelica.Fluid.Dissipation.PressureLoss.Orifice"
  ...
  parameter StateSelect dpStateSelect = StateSelect.default "State select for pressure difference dp"
    annotation(Dialog(tab = "Advanced"));
  parameter ThermofluidStream_v2.Utilities.Units.Inertance L_value = dropOfCommons.L "Inertance of pipe"
    annotation(Dialog(tab = "Advanced"));
...
<p> 
The pipe bend component is using the partial model <a href=\"modelica://ThermofluidStream_v2.Processes.Pipes.Interfaces.SISOFlow_nonConstArea\">SISOFlow_nonConstArea</a> implementing the common 
