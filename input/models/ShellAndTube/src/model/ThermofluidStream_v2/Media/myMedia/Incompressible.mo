...
<li><strong>Essotherm650</strong>, a medium model for thermal oil, also based on tables.</li>
  ...
  package TableBased "Incompressible medium properties based on tables"
    ...
    extends ThermofluidStream_v2.Media.myMedia.Interfaces.PartialMedium(
      ThermoStates=if enthalpyOfT then ThermofluidStream_v2.Media.myMedia.Interfaces.Choices.IndependentVariables.T
           else ThermofluidStream_v2.Media.myMedia.Interfaces.Choices.IndependentVariables.pT,
      final reducedX=true,
      final fixedX=true,
