...
model PCV "Pressure and pressure-drop control valve"
  extends ThermofluidStream_v2.Interfaces.SISOFlow(final clip_p_out=true);

  import Mode = ThermofluidStream_v2.FlowControl.Internal.Types.PressureControlValveMode;
...
equation
  ...
  dp = ThermofluidStream_v2.Undirected.Internal.regStep(m_flow - m_flow_reg, min(0, dp_raw), 0, m_flow_reg);
