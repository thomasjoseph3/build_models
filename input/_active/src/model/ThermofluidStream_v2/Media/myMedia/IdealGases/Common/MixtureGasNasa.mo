...
partial package MixtureGasNasa
  ...
  extends ThermofluidStream_v2.Media.myMedia.Interfaces.PartialMixtureMedium(
...
//   end FluidConstants;
  ...
  constant ThermofluidStream_v2.Media.myMedia.IdealGases.Common.DataRecord[:] data
...
required from medium model \"" + mediumName + "\".");
  ...
  function h_TX "Return specific enthalpy"
    import ThermofluidStream_v2.Media.myMedia.Interfaces.Choices;
     extends Modelica.Icons.Function;
     ...
     input Boolean exclEnthForm=excludeEnthalpyOfFormation
      "If true, enthalpy of formation Hf is not included in specific enthalpy h";
     input ThermofluidStream_v2.Media.myMedia.Interfaces.Choices.ReferenceEnthalpy
  ...
  algorithm
    h := (if fixedX then reference_X else X)*{
      ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.h_T(
        data[i],
        T,
        exclEnthForm,
        refChoice,
  ...
  algorithm
    h_der := if fixedX then dT*sum((
      ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.cp_T(data[i],
      T)*reference_X[i]) for i in 1:nX) else dT*sum((
      ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.cp_T(data[i],
      T)*X[i]) for i in 1:nX) + sum((
      ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.h_T(data[i],
  ...
  algorithm
    cp := {ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.cp_T(
  ...
  algorithm
    cv := {ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.cp_T(
  ...
  algorithm
    s := sum(ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.s0_T(
...
average of the pure component conductivities.
    ...
    assert(fluidConstants[i].hasCriticalData, "Critical data for "+ fluidConstants[i].chemicalFormula +
      ...
      eta[i] :=
        ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.dynamicViscosityLowPressure(
            ...
            fluidConstants[i].acentricFactor,
            fluidConstants[i].dipoleMoment);
      cp[i] := ThermofluidStream_v2.Media.myMedia.IdealGases.Common.Functions.cp_T(
        data[i], state.T);
      lambdaX[i] :=
  ...
  function T_hX "Return temperature from specific enthalpy and mass fraction"
    ...
    input Boolean exclEnthForm=excludeEnthalpyOfFormation
      "If true, enthalpy of formation Hf is not included in specific enthalpy h";
    input ThermofluidStream_v2.Media.myMedia.Interfaces.Choices.ReferenceEnthalpy refChoice=
  ...
  protected
    function f_nonlinear "Solve h_TX(T,X) for T with given h"
      ...
      input
        ThermofluidStream_v2.Media.myMedia.Interfaces.Choices.ReferenceEnthalpy refChoice
        "Choice of reference enthalpy";
