...
model Compressor "Test for compressors"
  ...
  replaceable package Medium = ThermofluidStream_v2.Media.myMedia.CompressibleLiquids.LinearWater_pT_Ambient "Medium model"
    annotation (Documentation(info="<html>
<p>
Medium model for the test. Should be an ideal gas or close to that.
</p>
</html>"));  // ThermofluidStream_v2.myMedia.Air.SimpleAir;
