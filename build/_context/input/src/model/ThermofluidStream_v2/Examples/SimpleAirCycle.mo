...
model SimpleAirCycle "Basic bootstrap cooling cycle"
  ...
  replaceable package Medium_ram = ThermofluidStream_v2.Media.myMedia.Air.MoistAir
    constrainedby ThermofluidStream_v2.Media.myMedia.Interfaces.PartialMedium
    "Ram air"
    annotation(choicesAllMatching = true);
  replaceable package Medium_bleed = ThermofluidStream_v2.Media.myMedia.Air.MoistAir
    constrainedby ThermofluidStream_v2.Media.myMedia.Interfaces.PartialMedium
    "Bleed air"
    annotation(choicesAllMatching = true);
  ...
  ThermofluidStream_v2.HeatExchangers.CounterFlowNTU heatExchange_CounterFlowNTU(
    ...
    L=1) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-60,40})));
  ThermofluidStream_v2.HeatExchangers.CounterFlowNTU heatExchange_CounterFlowNTU1(
    redeclare package MediumA = Medium_ram,
    redeclare package MediumB = Medium_bleed,
    A=3,
    L=1) annotation (Placement(transformation(
  ...
  Processes.Compressor compressor(
    ...
    redeclare function dp_tau_compressor =
        ThermofluidStream_v2.Processes.Internal.TurboComponent.dp_tau_const_isentrop (
      omega_ref=2000,
      skew=1,
      m_flow_ref=1,
  ...
  ThermofluidStream_v2.HeatExchangers.CounterFlowNTU heatExchange_CounterFlowNTU2(
    redeclare package MediumA = Medium_ram,
    redeclare package MediumB = Medium_bleed,
    A=10,
    L=1) annotation (Placement(transformation(
  ...
  Topology.JunctionT1 junctionT1_1(redeclare package Medium=Medium_ram) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={20,-94})));
  ThermofluidStream_v2.Topology.JunctionT1
  ...
  ThermofluidStream_v2.Utilities.Icons.DLRLogo dLRLogo annotation (Placement(transformation(extent={{102,-18},{138,18}})));
initial equation
