within ThermofluidStream_v2.Undirected.Topology.Tests;
...
<p>This is the replaceable package that determines the medium of the Test. </p>
  ...
  replaceable function pLoss = ThermofluidStream_v2.Processes.Internal.FlowResistance.laminarTurbulentPressureLoss (
    material=ThermofluidStream_v2.Processes.Internal.Material.wood)
    constrainedby ThermofluidStream_v2.Processes.Internal.FlowResistance.partialPressureLoss
...
<p>This is the pressure loss function used for all resistances except the two on the outlets of the right two cases.</p>
  ...
  ThermofluidStream_v2.Boundaries.Source source(redeclare package Medium=Medium,
      p0_par=200000)
    annotation (Placement(transformation(extent={{-160,30},{-140,50}})));
  ThermofluidStream_v2.Boundaries.Sink sink(redeclare package Medium=Medium,
      p0_par=150000)
    annotation (Placement(transformation(extent={{-20,50},{0,70}})));
  ThermofluidStream_v2.Boundaries.Sink sink1(redeclare package Medium=Medium,
      p0_par=100000)
    annotation (Placement(transformation(extent={{-20,10},{0,30}})));
  ThermofluidStream_v2.Topology.SplitterT1 splitterT1_1(redeclare package Medium=Medium, L=
        2*dropOfCommons.L)
  ...
  ThermofluidStream_v2.Processes.FlowResistance flowResistance1(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    r=0.1,
    l=1,
  ...
  ThermofluidStream_v2.Boundaries.Source source2(
    redeclare package Medium = Medium, p0_par=2000000)
    annotation (Placement(transformation(extent={{0,50},{20,70}})));
  ThermofluidStream_v2.Boundaries.Source source3(
    redeclare package Medium = Medium, p0_par=3500000)
    annotation (Placement(transformation(extent={{0,10},{20,30}})));
  ThermofluidStream_v2.Processes.FlowResistance flowResistance4(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    r=0.1,
    l=1,
  ...
  ThermofluidStream_v2.Processes.FlowResistance flowResistance5(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    r=0.1,
    l=1,
  ...
  ThermofluidStream_v2.Topology.JunctionT1 junctionT1_1(redeclare package Medium=Medium,
    assumeConstantDensity=false,
    L=2*dropOfCommons.L)
    annotation (Placement(transformation(extent={{74,30},{94,50}})));
  ThermofluidStream_v2.Boundaries.Sink sink4(
    redeclare package Medium = Medium, p0_par=100000)
    annotation (Placement(transformation(extent={{140,30},{160,50}})));
  ThermofluidStream_v2.Boundaries.Source source6(redeclare package Medium = Medium,
      p0_par=200000)
    annotation (Placement(transformation(extent={{-160,-50},{-140,-30}})));
  ThermofluidStream_v2.Boundaries.Sink sink6(redeclare package Medium = Medium,
      p0_par=150000)
    annotation (Placement(transformation(extent={{-20,-30},{0,-10}})));
  ThermofluidStream_v2.Boundaries.Sink sink7(redeclare package Medium = Medium,
      p0_par=100000)
  ...
  ThermofluidStream_v2.Processes.FlowResistance flowResistance8(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    r=0.1,
    l=1,
  ...
  ThermofluidStream_v2.Processes.FlowResistance flowResistance9(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    r=0.1,
    l=1,
  ...
  ThermofluidStream_v2.Boundaries.Source source7(redeclare package Medium = Medium, p0_par=2000000)
    annotation (Placement(transformation(extent={{0,-30},{20,-10}})));
  ThermofluidStream_v2.Boundaries.Source source8(redeclare package Medium = Medium, p0_par=3500000)
    annotation (Placement(transformation(extent={{0,-70},{20,-50}})));
  ThermofluidStream_v2.Processes.FlowResistance flowResistance10(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    r=0.1,
    l=1,
  ...
  ThermofluidStream_v2.Processes.FlowResistance flowResistance11(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    r=0.1,
    l=1,
  ...
  ThermofluidStream_v2.Boundaries.Sink sink8(redeclare package Medium = Medium,
      p0_par=100000)
  ...
  JunctionMN junctionMN1(redeclare package Medium = Medium,
    ...
    assumeConstantDensity=false)
    annotation (Placement(transformation(extent={{94,-50},{74,-30}})));
  ThermofluidStream_v2.Processes.FlowResistance flowResistance2(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    r=0.1,
    l=1,
  ...
  ThermofluidStream_v2.Processes.FlowResistance flowResistance3(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    r=0.1,
    l=1,
  ...
  ThermofluidStream_v2.Processes.FlowResistance flowResistance6(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    r=0.1,
    l=1,
    redeclare function pLoss =
        ThermofluidStream_v2.Processes.Internal.FlowResistance.linearQuadraticPressureLoss (
         k=1000))
    annotation (Placement(transformation(extent={{116,-50},{136,-30}})));
  ThermofluidStream_v2.Processes.FlowResistance flowResistance7(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    r=0.1,
    l=1,
