...
package CompressibleLiquids "Compressible liquid models"
  ...
  package Common "Base classes for compressible liquids"
    ...
    partial package LinearWater_pT
      ...
      extends myMedia.Interfaces.PartialLinearFluid(
        ...
        reference_d=ThermofluidStream_v2.Media.myMedia.Water.StandardWater.density(
            state),
        reference_h=
            ThermofluidStream_v2.Media.myMedia.Water.StandardWater.specificEnthalpy(
            state),
        reference_s=
            ThermofluidStream_v2.Media.myMedia.Water.StandardWater.specificEntropy(
            state),
        cp_const=
            ThermofluidStream_v2.Media.myMedia.Water.StandardWater.specificHeatCapacityCp(
            state),
        beta_const=
            ThermofluidStream_v2.Media.myMedia.Water.StandardWater.isobaricExpansionCoefficient(
            state),
        kappa_const=
            ThermofluidStream_v2.Media.myMedia.Water.StandardWater.isothermalCompressibility(
            state),
        MM_const=ThermofluidStream_v2.Media.myMedia.Water.StandardWater.molarMass(
            state));

      constant
        ThermofluidStream_v2.Media.myMedia.Water.StandardWater.ThermodynamicState state=
          ThermofluidStream_v2.Media.myMedia.Water.StandardWater.setState_pT(
          reference_p, reference_T);
    end LinearWater_pT;
  end Common;
  ...
  package LinearWater_pT_Ambient
    ...
    extends
      ThermofluidStream_v2.Media.myMedia.CompressibleLiquids.Common.LinearWater_pT(
