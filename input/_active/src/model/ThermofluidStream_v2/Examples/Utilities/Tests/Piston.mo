within ThermofluidStream_v2.Examples.Utilities.Tests;
...
<p>Typically some sort of water.</p>
  ...
  ThermofluidStream_v2.Examples.Utilities.Piston piston2_1(
  ...
  ThermofluidStream_v2.Utilities.showRealValue showRealValue annotation (Placement(transformation(extent={{32,-82},{52,-62}})));
