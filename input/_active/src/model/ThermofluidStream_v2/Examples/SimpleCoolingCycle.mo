...
extends Modelica.Icons.Example;
  ...
  replaceable package Medium_air = ThermofluidStream_v2.Media.myMedia.Air.DryAirNasa
    constrainedby ThermofluidStream_v2.Media.myMedia.Interfaces.PartialMedium
    "Air model"
    annotation(choicesAllMatching = true);

  ThermofluidStream_v2.HeatExchangers.CounterFlowNTU heatExchange_CounterFlowNTU(
  ...
  ThermofluidStream_v2.Processes.Pump pump(
    redeclare package Medium = Medium_liquid,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    redeclare function dp_tau_pump = ThermofluidStream_v2.Processes.Internal.TurboComponent.dp_tau_centrifugal)
    annotation (Placement(transformation(extent={{-20,10},{-40,30}})));
  ThermofluidStream_v2.Processes.ThermalConvectionPipe thermalConvectionPipe(
    redeclare package Medium = Medium_liquid,
    r=0.005,
  ...
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm1(
    redeclare package Medium = Medium_liquid,
    temperatureUnit="degC")
    annotation (Placement(transformation(extent={{70,20},{50,40}})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm2(
    redeclare package Medium = Medium_liquid,
    temperatureUnit="degC")
    annotation (Placement(transformation(extent={{10,20},{-10,40}})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm3(
    redeclare package Medium = Medium_liquid,
    digits=2,
  ...
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm5(
    ...
    annotation (Placement(
        ...
        rotation=180,
        origin={62,-2})));
  ThermofluidStream_v2.Boundaries.Sink sink(
    redeclare package Medium = Medium_air,
  ...
  ThermofluidStream_v2.Processes.Fan fan(
    redeclare package Medium = Medium_air,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
  ...
  inner ThermofluidStream_v2.DropOfCommons dropOfCommons
  ...
  ThermofluidStream_v2.Utilities.showRealValue showRealValue1(
    use_numberPort=false,
    description="eff",
  ...
  ThermofluidStream_v2.Utilities.showRealValue showRealValue2
    annotation (Placement(transformation(extent={{-100,-40},{-120,-20}})));
  ThermofluidStream_v2.Utilities.Icons.DLRLogo dLRLogo annotation (Placement(transformation(extent={{142,-98},{178,-62}})));
equation
