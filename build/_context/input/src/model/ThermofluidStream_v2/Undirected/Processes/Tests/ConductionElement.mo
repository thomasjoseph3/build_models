within ThermofluidStream_v2.Undirected.Processes.Tests;
...
meant for liquids with low compressablility.
  ...
  ThermofluidStream_v2.Undirected.Processes.ConductionElement conductionElement(
    ...
    A=35,
    U=500,
    init=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.T,
  ...
  ThermofluidStream_v2.Undirected.Processes.ConductionElement conductionElement1(
    redeclare package Medium = Medium,
    L=0.2,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    V(displayUnit="l") = 0.001,
    A=35,
    U=500,
    init=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.h,
    T_0=263.15,
    h_0=1000,
  ...
  ThermofluidStream_v2.Undirected.Processes.ConductionElement conductionElement2(
    redeclare package Medium = Medium,
    L=0.2,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    m_flow_0=-1,
    ...
    A=35,
    U=500,
    init=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.fore,
  ...
  ThermofluidStream_v2.Undirected.Processes.ConductionElement conductionElement3(
    redeclare package Medium = Medium,
    L=0.2,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    m_flow_0=-1,
    ...
    A=35,
    U=500,
    init=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.rear,
  ...
  ThermofluidStream_v2.Undirected.Processes.ConductionElement conductionElement4(
    redeclare package Medium = Medium,
    L=0.2,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    m_flow_0=0,
    ...
    A=35,
    U=500,
    init=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.port,
  ...
  ThermofluidStream_v2.Undirected.Processes.ConductionElement conductionElement5(
    redeclare package Medium = Medium,
    L=0.2,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    m_flow_0=-1,
