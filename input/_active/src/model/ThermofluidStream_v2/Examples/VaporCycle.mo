...
model VaporCycle
  ...
  FlowControl.BasicControlValve controlValve(
    ...
    flowCoefficient=ThermofluidStream_v2.FlowControl.Internal.Types.FlowCoefficientTypesBasic.m_flow_set,
    Kvs=0.5,
  ...
  Sensors.SingleFlowSensor singleFlowSensor(
    redeclare package Medium = RefrigerantMedium,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.m_flow_kgps)
  ...
  ThermofluidStream_v2.Utilities.showRealValue coolingPower(
  ...
  ThermofluidStream_v2.Utilities.showRealValue compressorPower(
    use_numberPort=false,
    description="power",
    number=compressor.W_t) annotation (Placement(transformation(extent={{46,-12},{80,8}})));
  ThermofluidStream_v2.Utilities.showRealValue COP(
    use_numberPort=false,
    description="COP",
  ...
  ThermofluidStream_v2.Utilities.showRealValue superheating(
    use_numberPort=false,
  ...
  ThermofluidStream_v2.Utilities.showRealValue subcooling(
    use_numberPort=false,
  ...
  ThermofluidStream_v2.Utilities.Icons.DLRLogo dLRLogo annotation (Placement(transformation(extent={{182,-158},{238,-102}})));
equation
