...
Medium package used in the Test.
  ...
  ThermofluidStream_v2.Undirected.FlowControl.MCV
                                    mCV(
    redeclare package Medium = Medium,
  ...
  Boundaries.BoundaryRear boundaryRear1(
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=180,
        origin={70,-20})));
  ThermofluidStream_v2.Undirected.FlowControl.MCV mCV2(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    mode=ThermofluidStream_v2.FlowControl.Internal.Types.MassflowControlValveMode.volume_flow,
    massFlow_set_par=0.1,
  ...
  Boundaries.BoundaryRear boundaryRear6(
    ...
    p0_par=200000) annotation (Placement(transformation(extent={{-32,158},{-12,
            178}})));
  ThermofluidStream_v2.Undirected.FlowControl.MCV mCV6(
    redeclare package Medium = Medium,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    mode=ThermofluidStream_v2.FlowControl.Internal.Types.MassflowControlValveMode.mass_flow,
