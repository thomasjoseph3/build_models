...
model BasicControlValve "Test for BasicControlValve"
  ...
  replaceable package medium = ThermofluidStream_v2.Media.myMedia.Water.ConstantPropertyLiquidWater
...
Medium package used in the Test.
  ...
  FlowControl.BasicControlValve valveLinear(
    ...
    redeclare function valveCharacteristics =
        ThermofluidStream_v2.FlowControl.Internal.ControlValve.linearCharacteristics)
  ...
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm2(redeclare package
      Medium = medium)
    annotation (Placement(transformation(extent={{-40,60},{-20,80}})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm3(redeclare package
      Medium = medium)
  ...
  ThermofluidStream_v2.Boundaries.Sink sink2(redeclare package Medium = medium,
      p0_par=100000)
    annotation (Placement(transformation(extent={{96,-10},{116,10}})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm4(redeclare package
      Medium = medium)
    annotation (Placement(transformation(extent={{-40,0},{-20,20}})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm5(redeclare package
      Medium = medium)
  ...
  ThermofluidStream_v2.Boundaries.Sink sink3(redeclare package Medium = medium,
      p0_par=100000)
    annotation (Placement(transformation(extent={{96,-70},{116,-50}})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm7(redeclare package
      Medium = medium)
    annotation (Placement(transformation(extent={{-40,-60},{-20,-40}})));
  ThermofluidStream_v2.Sensors.MultiSensor_Tpm multiSensor_Tpm8(redeclare package
      Medium = medium)
