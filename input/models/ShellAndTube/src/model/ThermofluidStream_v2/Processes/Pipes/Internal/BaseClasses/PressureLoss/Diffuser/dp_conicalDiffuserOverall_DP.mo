within ThermofluidStream_v2.Processes.Pipes.Internal.BaseClasses.PressureLoss.Diffuser;
function dp_conicalDiffuserOverall_DP "Pressure loss of conical diffuser | calculate pressure loss | uniform velocity profile | overall flow regime"
  ...
  import c_spline = ThermofluidStream_v2.Processes.Pipes.Internal.Utilities.cubicHermite;
