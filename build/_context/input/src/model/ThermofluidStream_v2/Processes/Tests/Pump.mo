...
model Pump "Test for pumps"
  ...
  import tf = ThermofluidStream_v2;
...
Medium model for the test. Should be incompressible or with low compressibility.
  ...
  ThermofluidStream_v2.Processes.Pump pump(
    ...
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.derivative,
  ...
  ThermofluidStream_v2.Processes.Pump pump1(
    redeclare package Medium = Medium,
    L=1000000,
  ...
  tf.Processes.Pump pump3(
    ...
    omega_from_input=false,
    enableOutput=true,
    outputQuantity=ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.Cp_flow_JpKs,
    J_p=10,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    initOmega=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    initPhi=true,
  ...
  tf.Processes.Pump pump4(
    ...
    omega_from_input=true,
    enableOutput=true,
    outputQuantity=ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.V_flow_lpMin,
    J_p=10,
    initM_flow=ThermofluidStream_v2.Utilities.Types.InitializationMethods.state,
    phi_0=-1745.3292519943,
    redeclare function dp_tau_pump =
