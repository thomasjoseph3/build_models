within ThermofluidStream_v2.Undirected.Boundaries.Tests;
model PhaseSeperator
  ...
  ThermofluidStream_v2.Undirected.Boundaries.PhaseSeparator receiver(
    redeclare package Medium = Medium,
    p_start=110000,
    V_par(displayUnit="l") = 0.01,
    pipe_low=0.05,
    pipe_high=0.15,
    init_method=ThermofluidStream_v2.Boundaries.Internal.InitializationMethodsPhaseSeperator.l)
  ...
  ThermofluidStream_v2.Sensors.TwoPhaseSensorSelect twoPhaseSensorSelect(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.x_kgpkg) annotation (Placement(transformation(extent={{-84,-50},{-64,-30}})));
  ThermofluidStream_v2.Sensors.TwoPhaseSensorSelect twoPhaseSensorSelect1(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.x_kgpkg) annotation (Placement(transformation(extent={{56,-50},{76,-30}})));
  ThermofluidStream_v2.Sensors.TwoPhaseSensorSelect twoPhaseSensorSelect2(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.x_kgpkg) annotation (Placement(transformation(extent={{44,30},{64,50}})));
  ThermofluidStream_v2.Sensors.TwoPhaseSensorSelect twoPhaseSensorSelect3(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.x_kgpkg) annotation (Placement(transformation(extent={{116,-50},{136,-30}})));
  ...
  Processes.FlowResistance flowResistance1(
    ...
    l=1,
    computeL=false,
    redeclare function pLoss = ThermofluidStream_v2.Processes.Internal.FlowResistance.linearQuadraticPressureLoss (
      k=5000))
  ...
  ThermofluidStream_v2.Sensors.TwoPhaseSensorSelect twoPhaseSensorSelect4(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.x_kgpkg) annotation (Placement(transformation(extent={{-24,-50},{-4,-30}})));
  ThermofluidStream_v2.Sensors.TwoPhaseSensorSelect twoPhaseSensorSelect5(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.x_kgpkg) annotation (Placement(transformation(extent={{-16,30},{4,50}})));
  ThermofluidStream_v2.Sensors.SingleSensorSelect singleSensorSelect(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.p_bar) annotation (Placement(transformation(extent={{-16,42},{4,62}})));
  ThermofluidStream_v2.Sensors.SingleSensorSelect singleSensorSelect1(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.p_bar) annotation (Placement(transformation(extent={{44,42},{64,62}})));
  ThermofluidStream_v2.Sensors.SingleSensorSelect singleSensorSelect2(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.p_bar) annotation (Placement(transformation(extent={{-24,-62},{-4,-42}})));
  ThermofluidStream_v2.Sensors.SingleSensorSelect singleSensorSelect3(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.p_bar) annotation (Placement(transformation(extent={{56,-62},{76,-42}})));
  ThermofluidStream_v2.Sensors.SingleSensorSelect singleSensorSelect4(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.p_bar) annotation (Placement(transformation(extent={{116,-62},{136,-42}})));
  ThermofluidStream_v2.Sensors.SingleSensorSelect singleSensorSelect5(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.p_bar) annotation (Placement(transformation(extent={{-84,-62},{-64,-42}})));
  ...
  ThermofluidStream_v2.Sensors.TwoPhaseSensorSelect twoPhaseSensorSelect6(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.x_kgpkg) annotation (Placement(transformation(extent={{-76,30},{-56,50}})));
  ThermofluidStream_v2.Sensors.SingleSensorSelect singleSensorSelect6(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.p_bar) annotation (Placement(transformation(extent={{-76,42},{-56,62}})));
  BoundaryFore boundaryFore(
    redeclare package Medium = Medium,
    p0_par=100000)
    annotation (Placement(transformation(extent={{120,10},{140,30}})));
  ThermofluidStream_v2.Sensors.TwoPhaseSensorSelect twoPhaseSensorSelect7(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.x_kgpkg) annotation (Placement(transformation(extent={{104,30},{124,50}})));
  ThermofluidStream_v2.Sensors.SingleSensorSelect singleSensorSelect7(
    redeclare package Medium = Medium,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.p_bar) annotation (Placement(transformation(extent={{104,42},{124,62}})));
  ...
  ThermofluidStream_v2.Undirected.Boundaries.PhaseSeparator accumulator(
    redeclare package Medium = Medium,
    p_start=110000,
    V_par(displayUnit="l") = 0.01,
    pipe_low=0.05,
