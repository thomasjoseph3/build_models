within ThermofluidStream_v2.Processes;
model FlowResistance "Flow resistance model"
  ...
  import ThermofluidStream_v2.Processes.Internal.ShapeOfResistance "Shape of cross sectional area";
  ...
  replaceable function pLoss = Internal.FlowResistance.pleaseSelectPressureLoss
    ...
    annotation (
      choices(
        choice(
          redeclare function pLoss = ThermofluidStream_v2.Processes.Internal.FlowResistance.pleaseSelectPressureLoss
          "No function selected"),
        choice(
          redeclare function pLoss = ThermofluidStream_v2.Processes.Internal.FlowResistance.linearQuadraticPressureLoss
          "Linear-quadratic"),
        choice(
          redeclare function pLoss = ThermofluidStream_v2.Processes.Internal.FlowResistance.laminarPressureLoss
        ...
        choice(
          redeclare function pLoss =
            ThermofluidStream_v2.Processes.Internal.FlowResistance.laminarTurbulentPressureLossHaaland
          "Laminar-turbulent (Haaland1983)"),
        choice(
          redeclare function pLoss =
            ThermofluidStream_v2.Processes.Internal.FlowResistance.zetaPressureLoss
          "Fixed pressure loss coefficient"),
        choice(
          redeclare function pLoss =
            ThermofluidStream_v2.Processes.Internal.FlowResistance.referencePressureLoss
...
some medium properties and the geometry of the pipe.
  ...
  parameter ShapeOfResistance shape=ThermofluidStream_v2.Processes.Internal.ShapeOfResistance.circular "Cross section shape"
    annotation (Dialog(group = "Geometry",enable = true));
  parameter SI.Radius r(min=0) = 0 "Radius"
    annotation (Dialog(group = "Geometry", enable=(shape == ThermofluidStream_v2.Processes.Internal.ShapeOfResistance.circular)));
  parameter SI.Length a(min=0) = 0 "Rectangle width"
    annotation(Dialog(group = "Geometry", enable=(shape == ThermofluidStream_v2.Processes.Internal.ShapeOfResistance.rectangle)));
  parameter SI.Length b(min=0) = 0 "Rectangle height"
    annotation(Dialog(group = "Geometry", enable=(shape == ThermofluidStream_v2.Processes.Internal.ShapeOfResistance.rectangle)));
  parameter SI.Area areaCrossInput(min=0) = 0 "Cross-sectional area"
    annotation(Dialog(group = "Geometry", enable=(shape == ThermofluidStream_v2.Processes.Internal.ShapeOfResistance.other)));
