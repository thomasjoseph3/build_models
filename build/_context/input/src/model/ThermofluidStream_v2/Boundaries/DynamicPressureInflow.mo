within ThermofluidStream_v2.Boundaries;
...
<p>This inflow boundary is supposed to start an area of the model where dynamic pressure is taken into account. The area is ended with <a href=\"modelica://ThermofluidStream_v2.Boundaries.DynamicPressureOutflow\">DynamicPressureOutflows</a>.</p>
