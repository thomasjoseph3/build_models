...
partial model PartialTurboComponent "Partial model of turbo component"
  ...
  import Quantity = ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities;
  ...
  parameter InitializationMethods initOmega = ThermofluidStream_v2.Utilities.Types.InitializationMethods.none "Initialization method for angular velocity"
