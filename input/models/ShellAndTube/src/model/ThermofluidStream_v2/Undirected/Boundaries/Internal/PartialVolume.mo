within ThermofluidStream_v2.Undirected.Boundaries.Internal;
...
protected
  ...
  SI.Pressure r_rear_intern = ThermofluidStream_v2.Undirected.Internal.regStep(m_flow_rear, medium.p - Medium.pressure(state_in_rear), 0, m_flow_reg) "Rear port inertial pressure";
  SI.Pressure r_fore_intern = ThermofluidStream_v2.Undirected.Internal.regStep(m_flow_fore, medium.p - Medium.pressure(state_in_fore), 0, m_flow_reg) "Fore port inertial pressure";
