within ThermofluidStream_v2.Sensors.Tests;
...
<p>Medium Model for the lower stream. It must be a TwoPhaseMedium to test the vapor quantity sensors.</p>
  ...
  Processes.FlowResistance flowResistance(
    ...
    redeclare function pLoss = Processes.Internal.FlowResistance.laminarTurbulentPressureLoss (
      material=ThermofluidStream_v2.Processes.Internal.Material.galvanizedIron))
  ...
  SingleSensorSelect singleSensorSelect(redeclare package Medium = Medium1,
      quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.T_K)
  ...
  SingleSensorSelect singleSensorSelect1(redeclare package Medium = Medium1,
      quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.T_C)
  ...
  SingleSensorSelect singleSensorSelect2(redeclare package Medium = Medium1,
      quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.p_Pa)
  ...
  SingleSensorSelect singleSensorSelect3(redeclare package Medium = Medium1,
      quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.p_bar)
  ...
  SingleSensorSelect singleSensorSelect4(redeclare package Medium = Medium1,
      quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.r_Pa)
  ...
  SingleSensorSelect singleSensorSelect5(redeclare package Medium = Medium1,
      quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.r_bar)
  ...
  SingleSensorSelect singleSensorSelect6(redeclare package Medium = Medium1,
      quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.p_total_Pa)
  ...
  SingleSensorSelect singleSensorSelect7(redeclare package Medium = Medium1,
      quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.p_total_bar)
    annotation (Placement(transformation(extent={{-74,48},{-54,68}})));
  SingleSensorSelect singleSensorSelect8(
    redeclare package Medium = Medium1,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.h_Jpkg)
    annotation (Placement(transformation(extent={{-74,36},{-54,56}})));
  SingleSensorSelect singleSensorSelect9(
    redeclare package Medium = Medium2,
    outputValue=true,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.s_JpkgK)
  ...
  SingleSensorSelect singleSensorSelect10(redeclare package Medium = Medium2,
    outputValue=true,
      quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.rho_kgpm3,
    filter_output=true)
    annotation (Placement(transformation(extent={{-74,20},{-54,40}})));
  SingleSensorSelect singleSensorSelect11(
    redeclare package Medium = Medium2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.v_m3pkg,
    outputValue=true,
    filter_output=true,
    init=ThermofluidStream_v2.Sensors.Internal.Types.InitializationModelSensor.state,
  ...
  SingleSensorSelect singleSensorSelect12(redeclare package Medium = Medium2,
      quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.cv_JpkgK)
  ...
  SingleSensorSelect singleSensorSelect13(redeclare package Medium = Medium2,
      quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.cp_JpkgK)
    annotation (Placement(transformation(extent={{-74,-16},{-54,4}})));
  SingleSensorSelect singleSensorSelect14(
    redeclare package Medium = Medium2,
    outputValue=true,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.Quantities.a_mps)
  ...
  DifferenceTwoPhaseSensorSensorSelect differenceSensorVaporQuality(
    ...
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.x_kgpkg,
    outputValue=true)
  ...
  SingleFlowSensor singleFlowSensor(
    redeclare package Medium = Medium1,
    digits=3,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.m_flow_kgps) annotation (Placement(transformation(extent={{20,64},{40,84}})));
  SingleFlowSensor singleFlowSensor1(
    redeclare package Medium = Medium1,
    outputValue=true,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.H_flow_Jps) annotation (Placement(transformation(extent={{44,64},{64,84}})));
  SingleFlowSensor singleFlowSensor2(redeclare package Medium = Medium1, quantity=ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.Cp_flow_JpKs,
    outputValue=true,
    filter_output=true)
  ...
  SingleFlowSensor singleFlowSensor3(
    ...
    digits=5,
    outputValue=true,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.V_flow_m3ps,
    filter_output=true,
    init=ThermofluidStream_v2.Sensors.Internal.Types.InitializationModelSensor.state) annotation (Placement(transformation(extent={{44,44},{64,64}})));
  SingleFlowSensor singleFlowSensor4(
    redeclare package Medium = Medium1,
    digits=5,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.V_flow_lpMin)
    annotation (Placement(transformation(extent={{68,44},{88,64}})));
  SingleFlowSensor singleFlowSensor5(
    redeclare package Medium = Medium1,
    outputValue=true,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.MassFlowQuantities.H_flow_Jps) annotation (Placement(transformation(extent={{68,64},{88,84}})));
  TwoPhaseSensorSelect twoPhaseSensorSelect(redeclare package Medium = Medium2, quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.x_kgpkg)
    annotation (Placement(transformation(extent={{-74,-58},{-54,-38}})));
  TwoPhaseSensorSelect twoPhaseSensorSelect1(redeclare package Medium = Medium2, quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.p_sat_Pa)
    annotation (Placement(transformation(extent={{-74,-70},{-54,-50}})));
  TwoPhaseSensorSelect twoPhaseSensorSelect2(redeclare package Medium = Medium2, quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.p_sat_bar)
    annotation (Placement(transformation(extent={{-74,-82},{-54,-62}})));
  TwoPhaseSensorSelect twoPhaseSensorSelect3(
    redeclare package Medium = Medium2,
    digits=2,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.T_sat_K)
    annotation (Placement(transformation(extent={{-74,-94},{-54,-74}})));
  TwoPhaseSensorSelect twoPhaseSensorSelect4(redeclare package Medium = Medium2, quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.T_sat_C)
    annotation (Placement(transformation(extent={{-50,-56},{-30,-36}})));
  TwoPhaseSensorSelect twoPhaseSensorSelect5(
    redeclare package Medium = Medium2,
    outputValue=true,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.T_oversat_K)
    annotation (Placement(transformation(extent={{-50,-68},{-30,-48}})));
  TwoPhaseSensorSelect twoPhaseSensorSelect6(redeclare package Medium = Medium2, quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.p_oversat_Pa)
    annotation (Placement(transformation(extent={{-50,-80},{-30,-60}})));
  TwoPhaseSensorSelect twoPhaseSensorSelect7(
    redeclare package Medium = Medium2,
    digits=3,
    outputValue=true,
    quantity=ThermofluidStream_v2.Sensors.Internal.Types.TwoPhaseQuantities.p_oversat_bar,
  ...
  DifferenceSensor_Tp differenceSensor_Tp1(
    ...
    pressureUnit="bar",
    filter_output=true,
    init=ThermofluidStream_v2.Sensors.Internal.Types.InitializationModelSensor.state) annotation (Placement(transformation(extent={{-4,8},{16,28}})));
