...
partial model partialSplitterY "Duplicate of SplitterM considering dynamic effects"
  ...
  parameter ThermofluidStream_v2.Utilities.Units.Inertance L = dropOfCommons.L "Inertance"
    annotation(Dialog(tab = "Advanced"));

  ThermofluidStream_v2.Interfaces.Inlet inlet(redeclare package Medium = Medium) "Inlet"
    annotation(Placement(transformation(extent = {{-120, -20}, {-80, 20}}), iconTransformation(extent = {{-120, -20}, {-80, 20}})));
  ThermofluidStream_v2.Interfaces.Outlet outlet_straight(redeclare package Medium = Medium) "Straight outlet"
  ...
  ThermofluidStream_v2.Interfaces.Outlet outlet_branching(redeclare package Medium = Medium) "Branching outlet"
  ...
  SI.Pressure r_mix;
equation
  // Inertial pressure calculation from ThermofluidStream_v2
...
<p>
Extension of <a href=\"modelica://ThermofluidStream_v2.Topology.SplitterN\">SplitterN</a> to consider dynamic pressure. The outlets vector is replaced with two independent outlets and Bernuolli's principle 
