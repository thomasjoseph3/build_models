within ThermofluidStream_v2.Undirected.HeatExchangers.Internal;
partial model PartialDiscretizedHEX "Base class for undirected discretized heat exchangers"

  extends ThermofluidStream_v2.HeatExchangers.Internal.DiscretizedHexIcon;
  extends ThermofluidStream_v2.Utilities.DropOfCommonsPlus;

  replaceable package MediumA = ThermofluidStream_v2.Media.myMedia.Interfaces.PartialMedium "Medium model side A"
    annotation (choicesAllMatching=true, Dialog(group="Medium definitions"));
  replaceable package MediumB = ThermofluidStream_v2.Media.myMedia.Interfaces.PartialMedium "Medium model side B"
    annotation (choicesAllMatching=true, Dialog(group="Medium definitions"));
  replaceable model ConductionElementA = ThermofluidStream_v2.Undirected.HeatExchangers.Internal.ConductionElementHEX constrainedby ThermofluidStream_v2.Undirected.HeatExchangers.Internal.PartialConductionElementHEX(
  ...
  replaceable model ConductionElementB = ThermofluidStream_v2.Undirected.HeatExchangers.Internal.ConductionElementHEX constrainedby ThermofluidStream_v2.Undirected.HeatExchangers.Internal.PartialConductionElementHEX(
  ...
  parameter ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement init_A=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.h "Initialization method for h side A" annotation (Dialog(tab="Initialization", group="Enthalpy"), choices(
      choice=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.h "h0",
      choice=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.rear "rear",
      choice=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.fore "fore"));
  parameter SI.SpecificEnthalpy h0_A=MediumA.h_default "Start value for specific enthalpy side A" annotation (Dialog(
      tab="Initialization",
      group="Enthalpy",
      enable=(init_A == ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.h)));
  parameter ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement init_B=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.h "Initialization method for h side B" annotation (Dialog(tab="Initialization", group="Enthalpy"), choices(
      choice=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.h "h0",
      choice=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.rear "rear",
      choice=ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.fore "fore"));
  parameter SI.SpecificEnthalpy h0_B=MediumB.h_default "Start value for specific enthalpy side B" annotation (Dialog(
      tab="Initialization",
      group="Enthalpy",
      enable=(init_B == ThermofluidStream_v2.Undirected.Processes.Internal.InitializationMethodsCondElement.h)));
  ...
  ThermofluidStream_v2.HeatExchangers.Internal.DiscretizedHEXSummary summary "Summary record of quantities";
...
protected
  ...
  function efficiency = ThermofluidStream_v2.HeatExchangers.Internal.calculateEfficiency (redeclare package MediumA = MediumA, redeclare package MediumB = MediumB);
...
&quot;<a href=\"ThermofluidStream_v2.DropOfCommons\">DropOfCommons</a>.assertionLevel&quot;.
</p>
<p>
