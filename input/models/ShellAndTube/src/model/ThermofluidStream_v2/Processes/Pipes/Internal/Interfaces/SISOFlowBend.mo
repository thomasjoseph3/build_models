...
partial model SISOFlowBend "Duplicate of SISOFlow (rotated outlet by 90°)"
  ...
  parameter StateSelect m_flowStateSelect = StateSelect.default "State selection for mass flow rate"
    annotation(Dialog(tab="Advanced"));
  parameter InitializationMethods initM_flow = ThermofluidStream_v2.Utilities.Types.InitializationMethods.none "Initialization method for mass flow rate"
  ...
  parameter ThermofluidStream_v2.Utilities.Units.MassFlowAcceleration m_acceleration_0 = 0 "Initial value for derivative of mass flow rate"
...
<p>
Duplicate of <a href=\"modelica://ThermofluidStream_v2.Interfaces.SISOFlow\">SISOFlow</a> (with rotated outlet connector).
</p>
</html>"));
end SISOFlowBend;
