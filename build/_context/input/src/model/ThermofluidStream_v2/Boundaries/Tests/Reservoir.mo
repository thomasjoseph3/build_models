...
<p>Medium Model for the test. Be aware that the Component is mainly meant for liquids with low compressablility.</p>
  ...
  ThermofluidStream_v2.Boundaries.Reservoir reservoir(redeclare package Medium=Medium,
    pEnvFromInput=true,
    A_surf=0.01,
    T_start=293.15,
    height_0=0.1)
    annotation (Placement(transformation(extent={{-14,-66},{6,-46}})));
  ThermofluidStream_v2.Boundaries.Reservoir reservoir1(redeclare package Medium=Medium,
    A_surf=0.05,
